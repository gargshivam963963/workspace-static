...
const SetNewPassword = () => {
    ...
    return (
        <StepCard heading="Set a password" subheading="Your previous password has been reseted. Please set a new password for your account." onClick={() => form.submit()} btnText="Set Password & Continue" >
            <Form
            ...
            >
                <section className={styles.verifyWrapper}>
                    <div className={styles.emailDisplay}>
                        Logged in as:
                        <span className={styles.minimessage}>sachindangi.pmgengineering@gmail.com</span>
                    </div>
                    <Form.Item
                        name="password"
                        label="New Password"
